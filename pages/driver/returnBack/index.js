...
Page({
  ...
  onLoad: function (options) {
     ...
     // console.log(a)
     this.setData({
      shopList: App.globalData.storeList
     })
     let _this = this;
     App._get(
       'asset/setting', 
       ...
       function(res){
         _this.setData({
          ...
          shop_id: App.globalData.storeList[_this.data.index2].shop_id
         })
       }
       )
  },
  ...
  handleShopChange(e) {
    ...
    let index = e.detail.value;
    index = isNaN(index) ? 0 : Number(index);
    _this.setData({index2: index,shop_id: _this.data.shopList[index].shop_id})  
  },
